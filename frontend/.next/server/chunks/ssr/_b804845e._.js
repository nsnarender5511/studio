...
{
/* __next_internal_action_entry_do_not_use__ [{"00beabad38ad658c9c148e71efece76e2808b67897":"fetchExecutionHistory","408ab15764d405b369f2567d9ff97da58a60f1da1a":"fetchJobStatus","4099dec9ca4b5f29ed4b2d009a808d0c97091e0eb4":"startDocumentationProcess"},"",""] */ __turbopack_context__.s({
...
async function startDocumentationProcess(repoUrl) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return {
                error: `Backend Error: ${result.error || response.statusText || 'Failed to start process'}`
            };
        }
        ...
        if (result.job_id) {
            ...
            return {
                error: 'Backend did not return a job ID.'
            };
        }
    } catch (error) {
        ...
        if (errorMessage.includes('ECONNREFUSED') || errorMessage.includes('fetch failed')) {
            return {
                error: `Could not connect to the backend service at ${BACKEND_URL}. Is it running?`
            };
        }
        return {
...
async function fetchExecutionHistory() {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return {
                error: `Backend Error: ${data.error || response.statusText || 'Failed to fetch history'}`
            };
        }
        ...
        if (!Array.isArray(data)) {
            ...
            return {
                error: 'Invalid history format received from backend.'
            };
        }
...
async function fetchJobStatus(jobId) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return {
                error: `Backend Error: ${data.error || response.statusText || 'Failed to fetch status'}`
            };
        }
        ...
        return {
            error: `Failed to fetch status for job ${jobId}: ${errorMessage}`
        };
    }
}
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(startDocumentationProcess, "4099dec9ca4b5f29ed4b2d009a808d0c97091e0eb4", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(fetchExecutionHistory, "00beabad38ad658c9c148e71efece76e2808b67897", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(fetchJobStatus, "408ab15764d405b369f2567d9ff97da58a60f1da1a", null);
}}),
...
{
__turbopack_context__.s({
    "00beabad38ad658c9c148e71efece76e2808b67897": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchExecutionHistory"]),
    "408ab15764d405b369f2567d9ff97da58a60f1da1a": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchJobStatus"]),
    "4099dec9ca4b5f29ed4b2d009a808d0c97091e0eb4": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["startDocumentationProcess"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
}}),
...
{
__turbopack_context__.s({
    "00beabad38ad658c9c148e71efece76e2808b67897": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["00beabad38ad658c9c148e71efece76e2808b67897"]),
    "408ab15764d405b369f2567d9ff97da58a60f1da1a": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["408ab15764d405b369f2567d9ff97da58a60f1da1a"]),
    "4099dec9ca4b5f29ed4b2d009a808d0c97091e0eb4": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["4099dec9ca4b5f29ed4b2d009a808d0c97091e0eb4"])
});
